# Steam Manifest Hub — Project Overview

This repository contains a small static website used as an index for Steam manifests (AppIDs). It also contains a disclaimer page with a VirusTotal report reference.
